...
export function SavedWordCard({ item, onPress, onRemove }: SavedWordCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* ROW 1: teochew_char + bookmark (tap to remove) */}
        <View className="flex-row items-center justify-between">
          <Text className="text-[28px] font-bold text-brown-900">{item.teochew_char}</Text>
