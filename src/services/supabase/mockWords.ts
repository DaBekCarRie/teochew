...
export const MOCK_WORDS: WordEntry[] = [
  ...
  },
  {
    ...
    teochew_char: '糜',
    teochew_pengim: 'muê5',
    thai_meaning: 'ข้าวต้ม/โจ๊ก',
    english_meaning: 'congee',
    mandarin_char: '糜',
    mandarin_pinyin: 'mí',
    category: 'อาหาร',
    verified: true,
  ...
  },
  {
    id: 'mock-food-04',
    teochew_char: '粿條',
    teochew_pengim: 'guê2 diao5',
    thai_meaning: 'ก๋วยเตี๋ยว',
    english_meaning: 'rice noodles',
    mandarin_char: '粿条',
    mandarin_pinyin: 'guǒ tiáo',
    category: 'อาหาร',
    verified: true,
  },
  {
  ...
  },
  {
    ...
    teochew_char: '肉',
    teochew_pengim: 'nêg8',
    thai_meaning: 'เนื้อ (หมู)',
    english_meaning: 'meat (pork)',
    mandarin_char: '肉',
    mandarin_pinyin: 'ròu',
    category: 'อาหาร',
    verified: true,
  ...
  },
  {
    ...
    teochew_char: '糖',
    teochew_pengim: 'tng5',
    thai_meaning: 'น้ำตาล/หวาน',
    english_meaning: 'sugar / sweet',
    mandarin_char: '糖',
    mandarin_pinyin: 'táng',
    category: 'อาหาร',
    verified: true,
  },
  {
    id: 'mock-food-12',
    teochew_char: '鹹',
    teochew_pengim: 'giam5',
    thai_meaning: 'เค็ม',
    english_meaning: 'salty',
    mandarin_char: '咸',
    mandarin_pinyin: 'xián',
    category: 'อาหาร',
    verified: true,
  },
  // Lesson 5 — สี (colors)
  ...
  },
  {
    ...
    teochew_char: '青',
    teochew_pengim: 'cên1',
    thai_meaning: 'เขียว/น้ำเงิน',
    english_meaning: 'green / blue',
    mandarin_char: '青',
    mandarin_pinyin: 'qīng',
    category: 'สี',
    verified: true,
  },
  {
  ...
  },
  {
    ...
    teochew_char: '蓝',
    teochew_pengim: 'nam5',
    thai_meaning: 'น้ำเงิน (เข้ม)',
    english_meaning: 'blue (dark)',
    mandarin_char: '蓝',
    mandarin_pinyin: 'lán',
    category: 'สี',
    verified: true,
  ...
  },
  {
    id: 'mock-color-08',
    teochew_char: '橙',
    teochew_pengim: 'têng5',
    thai_meaning: 'ส้ม',
    english_meaning: 'orange',
    mandarin_char: '橙',
    mandarin_pinyin: 'chéng',
    category: 'สี',
    verified: true,
  },
  {
    id: 'mock-color-09',
    teochew_char: '粉紅',
    teochew_pengim: 'hung2 ang5',
    thai_meaning: 'ชมพู',
    english_meaning: 'pink',
    mandarin_char: '粉红',
    mandarin_pinyin: 'fěn hóng',
    category: 'สี',
    verified: true,
  },
  {
